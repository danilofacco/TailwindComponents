...
export function BrandedWithSuportedText() {
...
export function CustomWithCheckOnLeft() {
  ...
  */
  ...
  const [selected, setSelected] = useState(peopleList[3])
...
export function CustomWithStatusIndicator() {
  /* This example requires Tailwind CSS v2.0+ 
  import { Fragment, useState } from 'react'
  import { Listbox, Transition } from '@headlessui/react'
  import { CheckIcon, SelectorIcon } from '@heroicons/react/solid'
  */
  ...
  const [selected, setSelected] = useState(peopleOnline[3])
...
export function WithSecondaryText() {
  ...
  */
  ...
  const [selected, setSelected] = useState(peopleEmail[3])
