...
export function TwoColumnCardsWithSeparateSubmitActions() {
  return (
    <>
      <div>
...
export function TwoColumnCardsWithSidebar() {
  /*
  import { CreditCardIcon, KeyIcon, UserCircleIcon, UserGroupIcon, ViewGridAddIcon } from '@heroicons/react/outline'
*/
const navigation = [
...
export function TwoColumnInFullWidthCards() {
  return (
