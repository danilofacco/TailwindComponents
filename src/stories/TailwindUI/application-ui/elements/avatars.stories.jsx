...
export default {
  title: 'Tailwind UI/Application UI/Elements/Avatars',
};


export function AvatarGroupStackedBottomToTop() {
  return (
    <>
...
export function AvatarGroupStackedTopToBottom() {
  return (
    <>
...
export function CircularAvatarsWithBottomNotification() {
  return (
    <>
...
export function CircularAvatarsWithPlaceholderIcon() {
  return (
    <>
...
export function CircularAvatarsWithPlaceholderInitials() {
  return (
    <>
...
export function CircularAvatarsWithTopNotification() {
  return (
    <>
      <span className="inline-block relative">
        <img
...
export function RoundedAvatarsWithBottomNotification() {
  return (
    <>
      <span className="inline-block relative">
        <img
...
export function RoundedAvatarsWithTopNotification() {
  return (
    <>
      <span className="inline-block relative">
        <img
