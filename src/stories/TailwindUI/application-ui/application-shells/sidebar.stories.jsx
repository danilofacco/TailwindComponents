...
export function BrandSidebarWithLightHeader() {
  /*        
...
export function DarkSidebarWithLightHeader() {
  const [sidebarOpen, setSidebarOpen] = useState(false)
...
export function LightSidebarWithConstrainedContentArea() {
  const [sidebarOpen, setSidebarOpen] = useState(false)
...
export function LightSidebarWithLightBackground() {
  const [sidebarOpen, setSidebarOpen] = useState(false)
...
export function LightSidebarWithLightHeader() {
  const [sidebarOpen, setSidebarOpen] = useState(false)
