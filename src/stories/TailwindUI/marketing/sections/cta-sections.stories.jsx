...
export function BrandPanelWithOverlappingImage() {
  /*
  This example requires Tailwind CSS v2.0+ 
...
export function SimpleCenterBranded() {
  /* This example requires Tailwind CSS v2.0+ */
...
export function SimpleJustifiedOnLightBrand() {
  /* This example requires Tailwind CSS v2.0+ */
...
export function SimpleJustified() {
  /* This example requires Tailwind CSS v2.0+ */
...
export function SimpleStracked() {
  /* This example requires Tailwind CSS v2.0+ */
