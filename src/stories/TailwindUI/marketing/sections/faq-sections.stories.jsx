...
export function OffsetWithSupportingText() {
  /* This example requires Tailwind CSS v2.0+ */
const faqs = [
  {
...
export function ThreeColumnsWithIntroduction() {
  /* This example requires Tailwind CSS v2.0+ */
const faqs = [
  {
    id: 1,
...
export function TwoColumnsOnBrand() {
  /* This example requires Tailwind CSS v2.0+ */
const faqs = [
  {
    id: 1,
...
export function TwoColumnsWithDescriptionOnDark() {
  /* This example requires Tailwind CSS v2.0+ */
const faqs = [
  {
    id: 1,
...
export function TwoColumnsWithDescription() {
  /* This example requires Tailwind CSS v2.0+ */
const faqs = [
  {
    id: 1,
