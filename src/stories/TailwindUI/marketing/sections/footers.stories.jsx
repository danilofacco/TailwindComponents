...
export function FoutColumnWithNewsletterAndLocalizationDark() {
  /*
  This example requires Tailwind CSS v2.0+ 
...
export function FoutColumnWithNewsletterAndLocalization() {
...
export function FoutColumnWithNewsletterDark() {
  /*
  This example requires Tailwind CSS v2.0+ 
...
export function FoutColumnWithNewsletter() {
  /*
  This example requires Tailwind CSS v2.0+ 
