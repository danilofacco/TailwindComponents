...
export function DarkWithIllustration() {
  /*
  This example requires Tailwind CSS v2.0+ 
...
export function SplitWithNavbar() {
  /* This example requires Tailwind CSS v2.0+ 
import { Fragment } from 'react'
import { Popover, Transition } from '@headlessui/react'
import {
...
export function SplitWithScreenshot() {
  /*
  This example requires Tailwind CSS v2.0+ 
...
export function WithSignInForm() {
  /*
  This example requires Tailwind CSS v2.0+ 
...
export function WithSignUpAndMediaContent() {
  /*
  This example requires Tailwind CSS v2.0+ 
