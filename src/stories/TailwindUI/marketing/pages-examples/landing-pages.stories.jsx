...
import { ChevronRightIcon, ChevronDownIcon, ExternalLinkIcon,  StarIcon} from '@heroicons/react/solid'
...
export function IllustratedHeroWithScreenshotSection() {
  /*
  This example requires Tailwind CSS v2.0+ 
...
export function SimpleWithOffsetScreenshotHero() { 
  /*
  This example requires Tailwind CSS v2.0+ 
